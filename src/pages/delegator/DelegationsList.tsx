...
import { DelegatingCard } from './DelegatingCard';
...
export function DelegationList({ account }: Props) {
  const { currentEra } = useEra();
  ...
  return renderAsync(delegationList, {
    ...
    data: (data) => {
      ...
      return (
        <>
          <DelegatingCard account={account} delegationList={delegationList.data || []} />

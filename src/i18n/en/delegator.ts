...
const translation = {
  ...
  delegate: {
    ...
    undelegateValidNextEra:
      'Tokens will be undelegated from next era. They will then be locked for {{duration}} before you can withdraw. During this period, tokens do not earn any rewards. Note, you can instead redelegate to another indexer without waiting for the undelegation period',
    ...
    nonDelegatingDesc1: `You can participate in the SubQuery network as a Delegator by allocating your SQT tokens to indexers of your choice.`,
    ...
    delegationDesc:
      'View all Indexers you have delegated your SQT tokens to. In return for delegating, you will earn rewards in SQT from the rewards pool.',
    ...
    redelegateInfo:
      'Once confirmed, your funds will be re-delegated from indexer {{indexerName}} to {{reIndexerName}} from the next era.',
  },

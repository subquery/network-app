  ...
  translation: {
    ...
    myOffers: {
      ...
      withdraw: {
        ...
        description: `You are about to withdraw {{bigNumAmount}} ${
          import.meta.env.VITE_TOKEN
        } from this offer to your wallet`,
    ...
    offerMarket: {
      ...
      acceptModal: {
        ...
        dailyRewardsError: `Please stake more ${
          import.meta.env.VITE_TOKEN
        } or get more delegation to increase daily reward capacity.`,
    ...
    swap: {
      ...
      poolSizeTooltip: `This is the amount of ${
        import.meta.env.VITE_TOKEN
      } currently available to be purchased in the liquidity pool`,
      ...
      swappableBalanceTooltip: `This is calculated by the total rewards you’ve claimed minus the amount you’ve swapped for ${
        import.meta.env.VITE_STABLE_TOKEN
      }.`,
